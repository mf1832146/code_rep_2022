...
def add_args(parser):
    ...
    parser.add_argument("--model_type", default="deberta", type=str, choices=['deberta'])
    ...
    if args.use_ast:
        args.max_source_len = args.max_ast_len
    else:
        args.max_source_len = args.max_code_len
    if args.use_dfg:
        args.max_source_len += args.max_dfg_len
